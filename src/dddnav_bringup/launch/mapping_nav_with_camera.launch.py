"""
边建图边导航 + 视觉: FAST-LIO2 + LIO-SAM 回环 + 3D 导航 + RealSense + DDRNet 语义分割
...
def generate_launch_description():
    ...
    ld = LaunchDescription([
        ...
        DeclareLaunchArgument('nav_config', default_value=os.path.join(p2p_share, 'config', 'mid360_mapping_with_camera.yaml')),
        DeclareLaunchArgument('rviz_config', default_value=os.path.join(bringup_share, 'rviz', 'mapping_nav.rviz')),
