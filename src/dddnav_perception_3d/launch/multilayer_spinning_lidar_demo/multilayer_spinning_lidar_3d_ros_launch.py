...
def generate_launch_description():
  ...
  bag_path = os.path.join(os.path.expanduser('~'), 'dddnav_bags', 'multilayer_spinning_lidar_pointcloud')
  ...
  b2l = Node(
          ...
          executable="static_transform_publisher",
          output="screen" ,
          arguments=["0.2", "0.0", "0.6", "3.1415926", "0.0", "0.0", "base_link", "laser_link"]
      )
  ...
  perception_3d_yaml = os.path.join(
      ...
      'multilayer_spinning_lidar_3d_ros.yaml'
      )
  ...
  rviz = Node(
          ...
          executable="rviz2",
          output="screen",
          arguments=['-d', os.path.join(get_package_share_directory('perception_3d'), 'rviz', 'multilayer_spinning_lidar_3d.rviz')]
  )  
