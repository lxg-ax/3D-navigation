...
CHAMP setup assistant 生成的四足配置包。本仓库里配合 Go2 见 [../README.md](../README.md)、[根 README](../../../README.md)。

This directory contains configuration packages of various quadrupedal robots generated by CHAMP's [setup assistant](https://github.com/chvmp/champ_setup_assistant).
